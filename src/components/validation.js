...
export function toggleButtonState(inputList, validationConf, buttonElementReturn) {
...
export const enableValidation = (validationConf) =>{
  const formElementlist = Array.from(document.querySelectorAll(validationConf.formSelector));
